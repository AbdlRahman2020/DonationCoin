...
contract DonationCoin {
    ...
    constructor() {
        ...
        // Adding the DonationCoin contract as the first Charity.
        Charity memory char =
            Charity(address(this), "General", "DonationCoin", true, 0);
        charities[address(this)] = char;
	...
	returns(uint)
	{
        ...
        emit NewDonation(msg.sender, _receiver, msg.value);
    ...
    function getCharityByCause(string memory _cause) external view
        returns (uint256[] memory)
    {
